...
//             </span>
//             <br />
//             <span className="text-gray-800 dark:text-gray-200">of Technology</span>
//           </h1>
          
//           <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
//             Choose your learning path and embark on an extraordinary journey into coding and artificial intelligence. 
//             From beginner-friendly courses to advanced AI mastery.
//           </p>
...
//                               {index === 0 && "Perfect for newcomers to programming and AI"}
//                               {index === 1 && "Build on your foundation with advanced concepts"}
//                               {index === 2 && "Master complex algorithms and AI architectures"}
//                               {index > 2 && "Specialized track for focused learning"}
//                             </p>
//                           </div>
//                         </div>
...
//                 We're working hard to bring you amazing Coding & AI courses. Check back soon for updates!
//               </p>
//             </div>
//           )}
//         </div>
...
//         {/* Footer CTA */}
//         {levels.length > 0 && (
//           <div className="text-center mt-16 p-8 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl text-white">
//             <h2 className="text-2xl font-bold mb-4">Ready to Start Your Journey?</h2>
//             <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
//               Join thousands of students who are already building the future with code and AI. 
