...
const BatchLibrary = () => {
        ...
        const fetchBatchContent = async () => {
            ...
            try {
                ...
                if (lectures.length === 0) {
                    setEnrolledBatches(prev => prev.map(b => b.$id === selectedBatchId ? { ...b, lectures: [], resources: [] } : b));
                    return;
                }
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-gray-900/50 flex flex-col lg:flex-row font-sans">
            <BatchSelector 
