...
const Sidebar = ({
  ...
  // For pending teachers, disable collapse toggle and limit interactions
  ...
  return (
    ...
    >
      ...
      <nav className="flex-grow px-3 py-4 flex flex-col overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700">
        ...
        {/* Academic Classes Dropdown - Disabled for pending teachers */}
        ...
        {/* For pending teachers, add a note item */}
        {isPendingTeacher && (
