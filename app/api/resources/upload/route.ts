// This is to upload lecture resources
...
// This function handles POST requests made to /api/resources/upload
export async function POST(request: Request) {
  try {
    ...
    console.error("Error creating pre-signed URL for resource", error);
    return NextResponse.json({ error: "Error creating pre-signed URL for resource" }, { status: 500 });
  }
}